...
data Profile = Profile
  ...
  , device :: HwDevice -- ^ Which hardware wallet derivation the profile is dedicated to.
...
-------------------------------------------------
-- | The type representing information the user must supply in order to add a new `Profile`. This is
-- also used for editing profiles.
...
toProfile :: Network -> ProfileId -> NewProfile -> [Profile] -> Either Text Profile
toProfile network newProfileId NewProfile{..} otherProfiles
